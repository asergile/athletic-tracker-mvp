...
import { Plus, Clock, Activity, Target, Mic, FileText, Edit, ChevronLeft, Flag, User, Calendar, BarChart3 } from 'lucide-react'
      ...
      <div className="px-6 pb-8">
        ...
        <div className="space-y-4">
          {workouts.map((workout) => {
            ...
            return (
              <div key={workout.id} className="bg-white rounded-2xl p-4 sm:p-6 shadow-lg hover:shadow-xl transition-all duration-200 relative">
                {/* Action Buttons */}
